...
def parse_args():
    ...
    parser.add_argument('--dataroot', type=str, default='data/nasdaq100_padding3.csv', help='path to dataset')
    ...
    parser.add_argument('--epochs', type=int, default=12, help='number of epochs to train [10, 100, 1000]')
...
def main():
    ...
    model = DA_RNN(X, y, args.timesteps, args.num_particles, args.encoder_hidden_size, args.batch_size, args.lr, args.epochs,
